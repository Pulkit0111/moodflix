  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-2xl mx-auto">
      <div className="relative">
        ...
        <button type="submit" className={`absolute right-2 top-1/2 -translate-y-1/2 bg-red-600 hover:bg-red-700 text-white rounded-full font-medium transition-colors ${large ? "px-6 py-3 text-lg" : "px-4 py-2 text-sm"}`}>Search</button>
      </div>
    </form>
  );
}
